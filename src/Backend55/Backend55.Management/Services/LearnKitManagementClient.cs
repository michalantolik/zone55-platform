    ...
    : ILearnKitManagementClient
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return created?.ArticleId
            ?? throw new HttpRequestException("Backend55.Api did not return the created article identifier.");
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return created?.BlockId
            ?? throw new HttpRequestException("Backend55.Api did not return the created block identifier.");
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        throw new HttpRequestException(
            $"Backend55.Api returned {(int)response.StatusCode} ({response.StatusCode}). {details}");
    }
